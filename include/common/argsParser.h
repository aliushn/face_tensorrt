...
//!         networks that use Uff
//!
struct FaceDetecNetParams : public SampleParams
{
    std::string pNetOnnxFileName; //!< Filename of ONNX file of pNet
    std::string oNetOnnxFileName; //!< Filename of ONNX file of oNet
    std::string rNetOnnxFileName; //!< Filename of ONNX file of rNet
    std::string lNetprototxtFileName; //!< Filename of prototxt design file of lNet
    std::string lNetweightsFileName;  //!< Filename of trained weights file of lNet
    std::string meanFileName;     //!< Filename of mean file of a network

    std::vector<std::string> pNetinputTensorNames;
    std::vector<std::string> pNetoutputTensorNames;
    std::vector<std::string> oNetinputTensorNames;
    std::vector<std::string> oNetoutputTensorNames;
    std::vector<std::string> rNetinputTensorNames;
    std::vector<std::string> rNetoutputTensorNames;
    std::vector<std::string> lNetinputTensorNames;
    std::vector<std::string> lNetoutputTensorNames;

    int pNetbatchSize{1};                  //!< Number of inputs in a batch
    int rNetbatchSize{1};                  //!< Number of inputs in a batch
    int oNetbatchSize{1};                  //!< Number of inputs in a batch
    int lNetbatchSize{1};                  //!< Number of inputs in a batch
