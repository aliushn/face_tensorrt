//
// Created by dylee on 2020-03-25.
//
...
int main(int argc, char** argv)
{
    ...
    std::cout << "Building det1.engine (PNet), maxBatchSize = 1"
              << std::endl;
    caffeToTRTModel("res/caffemodel/det1_relu.prototxt",
                    "res/caffemodel/det1_relu.caffemodel",
    ...
    std::cout << "Building det2.engine (RNet), maxBatchSize = 256"
              << std::endl;
    caffeToTRTModel("res/caffemodel/det2_relu.prototxt",
                    "res/caffemodel/det2_relu.caffemodel",
    ...
    std::cout << "Building det3.engine (ONet), maxBatchSize = 64"
              << std::endl;
    caffeToTRTModel("res/caffemodel/det3_relu.prototxt",
                    "res/caffemodel/det3_relu.caffemodel",
